# rustinsystems Linux installation guides

My brief instructions on how to install and apply my configs

## rustinsystems Arch Linux Hyprland setup
...
1. Clone the config files with `git clone https://github.com/rustinsystems/.dotfiles.git`
...
## rustinsystems Fedora Linux KDE Plasma setup
